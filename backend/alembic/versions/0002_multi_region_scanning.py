...
def upgrade() -> None:
    op.add_column("scan_runs", sa.Column("trigger", sa.String(length=32), nullable=False, server_default="scheduled"))
    op.add_column("scan_runs", sa.Column("batch_id", sa.String(length=36), nullable=True))
    op.add_column("scan_runs", sa.Column("attempt", sa.Integer(), nullable=False, server_default="1"))
    op.add_column("scan_runs", sa.Column("max_attempts", sa.Integer(), nullable=False, server_default="1"))
    op.add_column("scan_runs", sa.Column("api_request_count", sa.Integer(), nullable=False, server_default="0"))
    op.add_column("scan_runs", sa.Column("api_retry_count", sa.Integer(), nullable=False, server_default="0"))
    op.add_column("scan_runs", sa.Column("api_throttle_count", sa.Integer(), nullable=False, server_default="0"))
    op.add_column("scan_runs", sa.Column("api_concurrency_wait_seconds", sa.Float(), nullable=False, server_default="0"))
    op.add_column("scan_runs", sa.Column("api_retry_sleep_seconds", sa.Float(), nullable=False, server_default="0"))
    op.add_column("scan_runs", sa.Column("global_limits_skipped", sa.Integer(), nullable=False, server_default="0"))
    op.create_index("ix_scan_runs_trigger", "scan_runs", ["trigger"])
    op.create_index("ix_scan_runs_batch_id", "scan_runs", ["batch_id"])
    ...
    op.create_index("ix_monitored_regions_subscription_status", "monitored_regions", ["subscription_status"])
    ...
    op.create_index("ix_scan_requests_last_scan_run_id", "scan_requests", ["last_scan_run_id"])
